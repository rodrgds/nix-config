    ...
    sops.templates = {
      ...
      "montra-env" = {
        content = ''
          ...
          CATALOG_MAINTENANCE_SOURCE_IDS=isto,salsa,tiffosi,sacoor,calzedonia,bimbaylola,prof,bershka,stradivarius,jdsports,lefties,seaside,pullandbear,hm,primark,parfois,womensecret,springfield,cortefiel,camper,ca,decenio,intimissimi,sportzone
