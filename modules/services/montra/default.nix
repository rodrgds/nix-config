    ...
    sops.templates = {
      ...
      "montra-env" = {
        content = ''
          ...
          CATALOG_MAINTENANCE_SOURCE_IDS=isto,salsa,tiffosi,sacoor,calzedonia,bimbaylola,prof,bershka,stradivarius,jdsports,lefties,seaside,zara,pullandbear,hm,primark,parfois,womensecret,springfield,cortefiel,camper,ca,decenio,intimissimi,sportzone,aldo,mrblue,pedrodelhierro,underblue
          CATALOG_DERIVED_MAINTENANCE_ENABLED=1
          IMAGE_ASSET_CONCURRENCY=4
          IMAGE_NORMALIZE_CONCURRENCY=1
          VISUAL_APPEARANCE_CONCURRENCY=4
          VISUAL_APPEARANCE_BATCH_SIZE=4
