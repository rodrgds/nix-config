    ...
    sops.templates = {
      ...
      "montra-env" = {
        content = ''
          ...
          CATALOG_MAINTENANCE_SOURCE_IDS=isto,salsa,tiffosi,sacoor,calzedonia,bimbaylola,prof,bershka,stradivarius,jdsports,lefties,seaside,zara,pullandbear,hm,primark,intimissimi,camper
