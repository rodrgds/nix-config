...
STORY: Read the active workspace first, scan machine pressure second, then act on audio, displays, tray items, or power without leaving the rail.
FIRST VIEWPORT: A 28px bar spans each monitor; workspaces 1–10 sit left, flexible quiet space stays central, and live status plus controls terminate at the right edge.
